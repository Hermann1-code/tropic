...
const images = [
  { src: "/images/hero-hotel.jpg", alt: "Extérieur", span: "md:col-span-2 md:row-span-2" },
  { src: "/images/room-standard.jpg", alt: "Standard" },
  { src: "/images/room-comfort.jpg", alt: "Confort" },
  { src: "/images/lobby.jpg", alt: "Hall", span: "md:col-span-2" },
  { src: "/images/restaurant.jpg", alt: "Restaurant" },
  { src: "/images/room-suite.jpg", alt: "Suite" },
];
